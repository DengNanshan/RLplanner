...
# D_ROAD_W =4  # road width sampling length [m]
DT = 0.1  # time tick [s]
...
class JunctionTrajectoryPlanner_SP_Dns(object):
    ...
    def trajectory_update_CP(self, DCP_action, update=True):
        ...
        # 考虑出参考线条
        # print("equal len", len(bestpath.x) == len(bestpath.s))
        # if len(bestpath.x) == len(bestpath.s):
        #     trajectory_array = np.c_[bestpath.x, bestpath.y, 
        #                                                         bestpath.yaw, bestpath.s_d,
        #                                                         bestpath.s, bestpath.s_dd ]
        # else:
        #     lengthx=len(bestpath.x)
        #     trajectory_array = np.c_[bestpath.x, bestpath.y, 
        #                                                         bestpath.yaw, bestpath.s_d[0:lengthx],
        #                                                         bestpath.s[0:lengthx], bestpath.s_dd[0:lengthx] ]
